...
Criar um mini “Resumo tecnico” no topo do Builder mostrando 3 indicadores do blend (Maillard, Oxidacao, Estrutura).
Adicionar um pequeno “Por que isso” em cada alerta (ex: gordura mole + grelha = flare-up).
Desenhar um card visual de “Tempero perfeito” com base no corte dominante.


Completar os inputs do Builder (moagem, equipamento, estilo e presets de alvo) e o modo por gramas.
Criar o onboarding em 3 telas com dicas rápidas e CTA direto para o laboratório.
Implementar os templates de compartilhamento (cards prontos para WhatsApp/Instagram).